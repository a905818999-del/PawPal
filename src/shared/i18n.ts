...
export const I18N = {
  "zh-CN": {
    bubble: {
      ...
      mealReminder: ["到饭点啦，先吃点东西吧", "吃饭时间到了", "补充能量再继续"],
      mealDone: ["吃饭完成", "能量补给到位", "吃饱了就慢慢来"],
      focusStart: [
  ...
  en: {
    bubble: {
      ...
      mealReminder: ["Meal time. Eat something first.", "Time to eat.", "Refuel before continuing."],
      mealDone: ["Meal logged.", "Energy refilled.", "Good, take it easy."],
      focusStart: [
    ...
    menu: {
      ...
      demoMealReminder: "Demo: Meal Reminder",
    ...
    settings: {
      ...
      enableMealReminder: "Enable Meal Reminder",
